...
public class BartenderOrdersPage {
    private WebDriver driver;
    //*[@id="invoice"]/div/div/main/table[1]
    @FindBy(xpath = "//*[@id='invoice']/div/div/main/table[1]//*[@id='complete-order']")
    private List<WebElement> completeOrderButton;

    @FindBy(id = "bartender-orders")
    private WebElement myOrders;

    //@FindBy(id = "//*[@id='invoice']/div/div/main/table[1]/tbody")
    private List<WebElement> body;

    public BartenderOrdersPage(WebDriver driver) {
        this.driver = driver;
    }
